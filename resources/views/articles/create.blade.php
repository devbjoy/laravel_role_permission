                    ...
                    <div>
                        <form action="{{ route('articles.store') }}" method="POST">
                            ...
                            <div class="my-2">
                                ...
                                <input name="title" type="text" placeholder="Enter title" class="w-full border rounded-lg border-blue-500">
                                @error('title')
                            ...
                            <div class="my-2">
                                ...
                                <textarea cols="30" rows="10" name="content" type="text" placeholder="Enter content" class="w-full border rounded-lg border-blue-500 resize-none"></textarea>
                                @error('content')
                                    <p class="text-red-600 text-sm">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="my-2">
                                ...
                                <input name="author" type="text" placeholder="Enter author name" class="w-full border rounded-lg border-blue-500">
                                @error('author')
                                    <p class="text-red-600 text-sm">{{ $message }}</p>
                                @enderror
                            </div>
