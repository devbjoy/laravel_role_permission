                    ...
                    <div>
                        <form action="{{ route('users.update',$user->id) }}" method="POST">
                            ...
                            <div class="my-2">
                                ...
                                <input name="name" type="text" placeholder="Enter your role name" class="w-1/2 border rounded-lg border-blue-500" value="{{ old('name',$user->name) }}">
                                @error('name')
                            ...
                            <div class="my-2">
                                ...
                                <input name="email" type="text" placeholder="Enter your email" readonly class="w-1/2 border rounded-lg border-blue-500" value="{{ old('email',$user->email) }}">
                                @error('email')
                                    <p class="text-red-600 text-sm">{{ $message }}</p>
                                @enderror
                            </div>
